...
export function TV(props) {
    let tvData = props.tvData
    return (
        <div className="movies-section">
            <h1 className="movies-header">TV Series</h1>
            <div className="movie-details"> {tvData.map((data, idx) => <div className="movies-item" key={idx} style={{ backgroundImage: `url(${data.thumbnail.regular.small})` }}>
